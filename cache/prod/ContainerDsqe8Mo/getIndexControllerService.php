...
class getIndexControllerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.QswnJja'] ?? $container->load('get_ServiceLocator_QswnJjaService'))->withContext('App\\Engine\\Controller\\IndexController', $container));
