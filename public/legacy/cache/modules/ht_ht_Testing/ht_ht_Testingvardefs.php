<?php 
 $GLOBALS["dictionary"]["ht_ht_Testing"]=array (
  'table' => 'ht_ht_testing',
  'audited' => true,
  'inline_edit' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'ht_ht_testing_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'ht_ht_testing_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'ht_ht_testing_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_ht_ht_testing',
    ...
    'ht_ht_testing_type' => 
    array (
      'name' => 'ht_ht_testing_type',
      'vname' => 'LBL_TYPE',
      'type' => 'enum',
      'options' => 'ht_ht_testing_type_dom',
      'len' => 50,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'ht_ht_testing_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'ht_ht_testing_email_addresses',
      'module' => 'EmailAddress',
      'source' => 'non-db',
