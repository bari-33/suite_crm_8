<?php /* Smarty version 2.6.33, created on 2022-12-13 07:29:41
...
<button id="addFileButton" class="button primary case-addbutton" type="button"><?php echo $this->_tpl_vars['MOD']['LBL_ADD_CASE_FILE']; ?>
</button>
<?php echo '
<script>
...
" class="firstChild" value="<?php echo $this->_tpl_vars['MOD']['LBL_SELECT_CASE_DOCUMENT']; ?>
"
                        <?php echo '
                        onclick=\'open_popup(
                                "Documents",
...
<button class="removeFileButton case-removebutton" type="button"><?php echo $this->_tpl_vars['MOD']['LBL_REMOVE_CASE_FILE']; ?>
</button><br>
</span>
</script>