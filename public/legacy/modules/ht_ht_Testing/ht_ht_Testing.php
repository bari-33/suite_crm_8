...
class ht_ht_Testing extends Company
{
    public $new_schema = true;
    public $module_dir = 'ht_ht_Testing';
    public $object_name = 'ht_ht_Testing';
    public $table_name = 'ht_ht_testing';
